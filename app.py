...
DATASET_CACHE_DIR = Path("/tmp/dataset_cache")
...
def main():
    ...
    if source == "Upload Your Own":
        ...
        if source == "Use Public Demo Imagery":
            ...
            with col_load:
                if st.button("Load selected public image"):
            ...
            with col_random:
                if st.button("Load random public sample"):
            ...
            with col_g1:
                if st.button("Load selected GitHub sample"):
            ...
            with col_g2:
                if st.button("Load random GitHub sample"):
